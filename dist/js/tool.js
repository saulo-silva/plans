...
Nova.booting(function (Vue, router, store) {
    ...
    router.beforeEach(function (to, from, next) {
        if ((from.name === 'create' || from.name === 'edit') && from.query.viaRelationship !== '' && to.name === 'detail' && to.params.resourceName !== from.query.viaResource && from.query.viaResource === 'plans') {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Plans")]),
      _vm._v(" "),
      _c(
        "card",
        {
        ...
        [
          ...
          _c("p", { staticClass: "text-white-50% text-lg" }, [
            ...
            _c(
              ...
              [
                _vm._v(
                  "/nova-components/Plans/resources/js/components/Tool.vue"
                )
              ]
            )
          ])
